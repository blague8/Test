...
?>
	...
	if ($vergangene != ''){
	 if ($vergangene ==1){
		...
		<?php
			...
			$titel2='WS 2019/2020';
			$titel3='Differentialgleichungen';
	...
	?>
		...
		<?php
			$titel1= 'Vergangene Semester';
			$titel2='WS 2019/2020';
			$titel3='Formale Grundlagen der Informatik';
		   titeln($titel1, $titel2, $titel3);
		?>              
			</div>
			<div class="container">
