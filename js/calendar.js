            ...
            <div id='calendar' class="calendar">
                <header class="calendar__head">
                    ...
                    <table class="calendar__head-days">
                        <td class='calendar__head-days-item'>MO</td>
                        <td class='calendar__head-days-item'>DI</td>
                        <td class='calendar__head-days-item'>MI</td>
                        <td class='calendar__head-days-item'>DO</td>
                        <td class='calendar__head-days-item'>FR</td>
                        <td class='calendar__head-days-item'>SA</td>
                        <td class='calendar__head-days-item'>SO</td>
                    </table>
                </header>
